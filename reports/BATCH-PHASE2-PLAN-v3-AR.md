...
**الحالة:** العقد + الباركود + الخدمات + Admin UI + **تطبيق العامل — كلها مكتملة وCI أخضر** — الفرع `feature/ayrovi-batch` @ `198c969`
...
**قاعدة البوابة:** لا انتقال لشريحة جديدة باختبارات حمراء — الوضع الآن أخضر بالكامل على الفرع. **التالي: شريحة الاستلام** (فحص AYP في محطة موجودة — فحص إعادة استخدام DISPATCH أولًا → 10/10 → إكمال → تقرير).
